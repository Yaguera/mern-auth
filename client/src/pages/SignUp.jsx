  ...
  return (
    <div className='max-w-lg p-3 mx-auto'>
      ...
      <form className='flex flex-col gap-4'>
        ...
        <input type="text" placeholder='Email' id='email' className='bg-slate-100 rounded-lg p-3' />
        <input type="text" placeholder='Password' id='password' className='bg-slate-100 rounded-lg p-3' />
